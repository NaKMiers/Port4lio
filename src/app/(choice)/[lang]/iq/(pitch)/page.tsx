        ...
        >
          ...
          <ul className="mt-5 space-y-3">
            {sections.tips.map(tip => (
              <li
                key={tip}
                className="flex gap-3 text-pp-muted"
              >
                <span
                  aria-hidden
                  className="mt-2 h-1.5 w-1.5 flex-none rounded-full bg-pp-blue"
                />
                <span>{tip}</span>
              </li>
            ))}
        ...
        >
          ...
          <dl className="mt-6 space-y-5">
            {iqFaqEntries(lang, price).map(entry => (
              <div
                key={entry.q}
                className="border-b border-pp-line pb-5 last:border-b-0"
              >
                <dt className="font-display text-base font-semibold text-pp-text">
                  {entry.q}
                </dt>
