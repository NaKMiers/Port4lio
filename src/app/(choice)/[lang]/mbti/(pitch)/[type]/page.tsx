      ...
      */}
      ...
      >
        ...
        <nav
          ...
          className="mt-10 rounded-panel border border-pp-line bg-white/50 p-5"
        >
          <h2
            id="toc-heading"
        ...
        */}
              ...
              <li key={entry.role}>
                ...
                >
                  ...
                  <div>
                    ...
                    <h3
                      className={`mt-1 font-display text-base font-semibold ${accent.text}`}
                    >
        ...
        <div
          id="strengths"
          className="mt-12 grid scroll-mt-24 gap-4 md:grid-cols-2"
        >
          <EditorialPanel
            variant="strong"
            className="p-6"
          >
            ...
            <ul className="mt-4 space-y-2.5">
              {content.strengths.map(item => (
                <li
                  key={item}
                  className="flex gap-3 text-sm leading-relaxed text-pp-muted"
                >
                  <span
          ...
          >
            ...
            <ul className="mt-4 space-y-2.5">
              {content.growth.map(item => (
                ...
                >
                  <span
                    className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-pp-orange"
                    aria-hidden
                  />
                  {item}
                </li>
        ...
        */}
        ...
        >
          ...
          <p className="mt-4 flex gap-3 rounded-panel border border-[rgba(255,159,64,0.3)] bg-[rgba(255,159,64,0.07)] p-5 text-sm leading-relaxed text-pp-muted">
            <span
              className="mt-1.5 h-2 w-2 shrink-0 rounded-full bg-pp-orange"
              aria-hidden
            />
            {copy.careersCaveat}
          </p>
        ...
        <EditorialPanel
          id="relationships"
          variant="default"
          className="mt-12 scroll-mt-24 p-6"
        >
          <h2 className="font-display text-sm font-semibold uppercase tracking-[0.18em] text-pp-text">
        ...
        */}
        <section
          id="faq"
          aria-labelledby="type-faq-heading"
          className="mt-12 scroll-mt-24"
        >
          <h2
            id="type-faq-heading"
          ...
          <div className="mt-5 space-y-3">
            {faqs.map(({ q, a }) => (
              <EditorialPanel
                ...
                className="p-5"
              >
                <h3 className="font-display text-base font-semibold leading-snug text-pp-text">
                  {q}
                </h3>
                <p className="mt-2 text-sm leading-relaxed text-pp-muted">
                  {a}
        ...
        */}
        <nav
          className="mt-14 border-t border-pp-line pt-8"
          ...
          <ul className="mt-4 grid gap-3 sm:grid-cols-3">
            {siblings.map(sibling => {
              ...
              return (
                <li key={sibling}>
                  <Link
                    href={`/${lang}/mbti/${slugFromType(sibling)}`}
                  ...
                  >
                    ...
                    >
                      <p
                        className={`font-display text-base font-semibold tracking-tight ${accent.text}`}
                      >
                        {sibling}
                      </p>
