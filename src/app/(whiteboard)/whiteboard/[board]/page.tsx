 ...
 *                           └─ board ──▶ the owner's canvas (WhiteboardClient), with
...
const boardFor = cache(
  async (
    ...
    { limited: true } | { limited: false; board: SharedBoard | null }
  > => {
    ...
    return { limited: false, board: await resolveSharedBoard(key) }
  }
)
...
export async function generateMetadata({
  ...
  const shared = found.limited ? null : found.board
  return {
