...
export default function ProjectsSection({
  ...
  const addProject = () =>
    setProfile(p => ({
      ...
      projects: [
        ...p.projects,
        { title: '', overview: '', techStack: [], parts: [] },
      ],
    }))
  ...
  return (
    <Section
      id="projects"
      title="Work & Projects"
      badge="parts (image, description, link)"
    >
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={e =>
                setProfile(p => ({ ...p, workHeading: e.target.value }))
              }
            />
          </div>
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={e =>
                setProfile(p => ({ ...p, workSubHeading: e.target.value }))
              }
            />
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <p className={helpTextCls}>
                  Short summary of what the project is. Shown in the Overview
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <p className={helpTextCls}>
                  Comma or newline separated. Shown as chips under the overview
                  (first {PROJECT_TECH_LIMIT} render).
                </p>
                <ListTextarea
                  className={textareaCls}
                  value={prj.techStack ?? []}
              ...
              <div className="space-y-3 md:col-span-2">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className={helpTextCls}>
                      Each part can have an image, description, and a link.
                      Autoplay slider uses part images.
                    </p>
                  </div>
                  <button
                    type="button"
                          ...
                          <input
                            ...
                            onChange={async e => {
                              ...
                              if (file.size > MAX_UPLOAD_BYTES) {
                                setError(
                                  `Each image must be ${MAX_UPLOAD_MB_LABEL} MB or smaller`
                                )
                                return
                              }
                              setError(null)
                              setUploading(u => ({
                                ...u,
                                projects: { ...u.projects, [idx]: true },
                              }))
                              try {
                                const url = await uploadAssetToCloudinary(
                                  file,
                                  'project',
                                  idx
                                )
