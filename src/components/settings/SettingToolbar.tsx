        ...
        <div className="max-w-3xl space-y-3">
          ...
          <div>
            <h1 className="font-display text-3xl font-semibold tracking-tight text-pp-text sm:text-4xl">
              Shape the settings page with the same editorial energy as the live
              portfolio.
            </h1>
            <p className="mt-3 max-w-2xl text-sm leading-relaxed text-pp-muted sm:text-base">
              Update every story block, link, service, metric, and project from
              one surface. Uploads still go straight to Cloudinary, and saving
              still sends only the profile JSON.
            </p>
          </div>
