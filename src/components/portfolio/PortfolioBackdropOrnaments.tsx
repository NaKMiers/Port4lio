      ...
      */}
      <div className="pp-decorations">
        {ornaments.map((className, index) => (
          <div
            key={`${index}-${className.slice(0, 18)}`}
            className={cx('absolute hidden lg:block', className)}
          >
            {index === 1 ? (
        ...
        <div className="absolute left-[5%] top-[8%] hidden h-20 w-32 rotate-[-12deg] rounded-[2rem] border-t-[3px] border-dotted border-[rgba(51,152,255,0.28)] lg:block" />
        ...
        <div className="pp-float-delayed absolute left-[3%] top-[82%] hidden h-28 w-40 lg:block">
