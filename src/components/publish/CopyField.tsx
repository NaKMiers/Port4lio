  ...
  return (
    <div className="space-y-2">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <span
          className={`text-[11px] font-semibold tracking-[0.12em] ${counterCls}`}
        >
      ...
      {field.overflow ? (
        <p className={`${helpTextCls} text-[#7f2f2f]`}>
          Source is {field.sourceLength - field.limit} characters over the
          platform limit. The text above is already trimmed and safe to paste,
          but shortening the source reads better.
        </p>
      ) : null}
    </div>
  )
